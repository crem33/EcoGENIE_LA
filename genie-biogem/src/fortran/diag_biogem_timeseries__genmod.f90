        ...
        MODULE DIAG_BIOGEM_TIMESERIES__genmod
          INTERFACE 
            SUBROUTINE DIAG_BIOGEM_TIMESERIES(DUM_DTS,DUM_GENIE_CLOCK,  &
     &DUM_SFCATM1,DUM_SFXATM1,DUM_SFXOCN1,DUM_SFCSED1,DUM_SFXSED1,      &
     &DUM_SFXSUMROK1,DUM_SAVE,DUM_FORCESAVE,DUM_GEMLITE)
              ...
              LOGICAL(KIND=4), INTENT(IN) :: DUM_FORCESAVE
              LOGICAL(KIND=4), INTENT(IN) :: DUM_GEMLITE
            END SUBROUTINE DIAG_BIOGEM_TIMESERIES
          END INTERFACE 
        END MODULE DIAG_BIOGEM_TIMESERIES__genmod
