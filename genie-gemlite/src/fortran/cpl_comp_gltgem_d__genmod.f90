        ...
        MODULE CPL_COMP_GLTGEM_D__genmod
          INTERFACE 
            SUBROUTINE CPL_COMP_GLTGEM_D(DUM_N_ATM,DUM_N_OCN,DUM_N_I_OCN&
     &,DUM_N_J_OCN,DUM_N_K_OCN,DUM_GENIE_DATM1,DUM_GENIE_DOCN)
     ...
     &DUM_N_I_OCN,DUM_N_J_OCN,DUM_N_K_OCN)
          ...
          END INTERFACE 
        END MODULE CPL_COMP_GLTGEM_D__genmod
